...
test:
	...
	$(CCX) $(TEST_CCXFLAGS) $(GTEST_FLAGS) server_test.cc config_parser.cc response.cpp request.cpp request_handler.cpp request_handler_echo.cpp request_handler_static.cpp server.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LFLAGS) -o server_test
	...
	$(CCX) $(TEST_CCXFLAGS) $(GTEST_FLAGS) request_handler_echo_test.cc response.cpp request.cpp request_handler.cpp request_handler_echo.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LFLAGS) -o request_handler_echo_test
	$(CCX) $(TEST_CCXFLAGS) $(GTEST_FLAGS) request_handler_static_test.cc response.cpp request.cpp request_handler.cpp request_handler_static.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LFLAGS) -o request_handler_static_test
	$(CCX) $(TEST_CCXFLAGS) $(GTEST_FLAGS) request_handler_status_test.cc response.cpp request.cpp request_handler.cpp request_handler_status.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LFLAGS) -o request_handler_status_test
	$(CCX) $(TEST_CCXFLAGS) $(GTEST_FLAGS) request_handler_notFound_test.cc response.cpp request.cpp request_handler.cpp request_handler_status.cpp ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LFLAGS) -o request_handler_notFound_test
